...
echo ======================================
echo  Сборка проекта через CMake
echo ======================================
...
call :run_test "Тест 15: 0/0" "ERROR Domain error: 0/0 is undefined" "evaluate 0 0/0"
...
call :run_test "Тест 20: Пустые скобки" "ERROR: Empty parentheses" "evaluate 0 sin()"
...
findstr /C:"%expected%" temp_output.txt > nul
if %errorlevel% equ 0 (
